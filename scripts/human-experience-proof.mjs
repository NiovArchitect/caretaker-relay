...
async function main() {
  ...
  const smart40 = [
    ...
    ["s_next", "who is next", /Next|Maya|helper/i],
    ...
    ["s_hand", "prepare handoff", /handoff|Documents|summary|Care/i],
    ...
    ["s_contact", "emergency contact", /Marcus|Maya|contact|phone|Essential/i],
